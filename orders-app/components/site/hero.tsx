...
*/
export function Hero({ settings, productCount, member, stats, onOpenAccount }: { settings: Settings; productCount: number; member: MemberSession; stats: MemberStats | null; onOpenAccount: () => void }) {
  return (
    <HeroScene id="top" className="relative flex min-h-[78svh] flex-col overflow-hidden sm:min-h-svh">
      <>
        ...
        <Navbar settings={settings} member={member} stats={stats} onOpenAccount={onOpenAccount} />
